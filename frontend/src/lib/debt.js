/*
  The debt maths lives in shared/debt.js at the top of the project, and this file
  ...
  Every import in the app still says '../lib/debt', so nothing else had to change.
*/
export * from '../../../shared/debt.js';
