    ...
    <section className="bg-paper px-4 pb-6 sm:px-6">
      <div className="relative overflow-hidden rounded-[32px] bg-night text-onNight">
        ...
        <Container className="relative py-24 text-center lg:py-32">
          <Reveal>
            <span className="inline-flex items-center gap-2.5 rounded-full border border-white/15 px-3.5 py-1.5 text-2xs font-semibold uppercase tracking-widest2 text-onNight/70">
          ...
          <Reveal delay={150}>
            <p className="mx-auto mt-6 max-w-md text-[16px] leading-relaxed text-onNight/60">
