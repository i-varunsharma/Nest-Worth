    ...
    <section className="bg-paper px-4 pb-6 sm:px-6">
      <div className="relative overflow-hidden rounded-[32px] bg-night text-paper">
        ...
        <div
          ...
          style={{ background: 'radial-gradient(closest-side, rgba(31,83,64,0.55), rgba(169,124,44,0.18), transparent)' }}
          aria-hidden="true"
        />
        ...
        <Container className="relative py-24 text-center lg:py-32">
          ...
          <Reveal delay={220}>
            <div className="mt-10 flex flex-wrap justify-center gap-3">
              ...
              <Button href="#how" variant="ghostDark">Read how it works</Button>
            </div>
          </Reveal>
        </Container>
      </div>
